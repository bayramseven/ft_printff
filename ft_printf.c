...
/*   Updated: 2026/04/21 19:06:19 by bayram-seve      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ilk olarak printf
	...
	bir adet str değişkeni ve printf içindeki
		% 'nin sonrasındaki harfe gelene kadar olan yerleri kontrol etmek ve write yazdırmak için kullanacağım.
	...
	burada str nin içinde
		% olması durumunu kontrol için while a koşul ekleyeceğim.
		% ye denk olduğu anda belirtmiş olduğum fonksiyona gidecek ve orada bir çıktı verecek.
	fonsksiyona grdiğinde str i+1 diyerek
		% nin bir sağındaki harfin yazılmamasını sağlayacağım.
...
bu fonksiyonda ilk olarak
	%'den sonra ne geleceğini kontrol edecek. if fonksiyonu ile koşul sağlandığında gerekli yazdırma işlemleri devam edecek.
*/